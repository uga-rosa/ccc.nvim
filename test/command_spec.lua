...
local function CccPick()
  vim.cmd.CccPick()
end

---@param bufnr? integer
local function clear_buffer(bufnr)
  vim.api.nvim_buf_set_lines(bufnr or 0, 0, -1, true, {})
...
describe("Commands", function()
  ...
  describe("CccPick", function()
    ...
    it("Pick color", function()
      Keymap.spec(function()
        vim.api.nvim_buf_set_lines(0, 0, -1, true, { "#ffffff" })
        CccPick()
    ...
    describe("action", function()
      ...
      it("toggle output mode", function()
        Keymap.spec(function()
          CccPick()
          -- Default mode; RGB (input), hex (output)
          -- Toggle to hex_short
