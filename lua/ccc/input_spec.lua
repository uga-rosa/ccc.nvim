...
describe("input", function()
  ...
  describe("oklab", function()
    ...
    it("from_rgb", function()
      from_rgb_test(oklab, { 255, 0, 0 }, { 0.628, 0.4 * 0.5625, 0.4 * 0.315 }, { 0.1, 0.001, 0.001 })
    end)
    it("to_rgb", function()
      to_rgb_test(oklab, { 0.628, 0.4 * 0.5625, 0.4 * 0.315 }, { 255, 0, 0 })
    end)
  end)
  ...
  describe("oklch", function()
    ...
    it("from_rgb", function()
      from_rgb_test(oklch, { 255, 0, 0 }, { 0.628, 0.4 * 0.645, 29.234 }, { 0.1, 0.001, 0.001 })
    end)
    it("to_rgb", function()
      to_rgb_test(oklch, { 0.628, 0.4 * 0.645, 29.234 }, { 255, 0, 0 })
    end)
  end)
