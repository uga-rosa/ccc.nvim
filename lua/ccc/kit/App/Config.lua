...
---@alias ccc.kit.App.Config.SchemaInternal ccc.kit.App.Config.Schema|{ revision: integer }

---@class ccc.kit.App.Config
---@field private _cache ccc.kit.App.Cache
---@field private _default ccc.kit.App.Config.SchemaInternal
---@field private _global ccc.kit.App.Config.SchemaInternal
---@field private _filetype table<string, ccc.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, ccc.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default ccc.kit.App.Config.Schema
...
---@param config ccc.kit.App.Config.Schema
...
---@return fun(config: ccc.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: ccc.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: ccc.kit.App.Config.Schema) }
