...
---@class ccc.kit.Async.AsyncTask
---@field private value any
---@field private status ccc.kit.Async.AsyncTask.Status
...
---@param task ccc.kit.Async.AsyncTask
---@param status ccc.kit.Async.AsyncTask.Status
---@param value any
...
---@enum ccc.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: ccc.kit.Async.AsyncTask.Status, value: any }
