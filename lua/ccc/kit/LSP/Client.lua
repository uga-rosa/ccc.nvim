...
---@param params ccc.kit.LSP.ImplementationParams
...
---@param params ccc.kit.LSP.TypeDefinitionParams
...
---@class ccc.kit.LSP.IntersectionType01 : ccc.kit.LSP.ConfigurationParams, ccc.kit.LSP.PartialResultParams

---@param params ccc.kit.LSP.IntersectionType01
...
---@param params ccc.kit.LSP.DocumentColorParams
...
---@param params ccc.kit.LSP.ColorPresentationParams
...
---@param params ccc.kit.LSP.FoldingRangeParams
...
---@param params ccc.kit.LSP.DeclarationParams
...
---@param params ccc.kit.LSP.SelectionRangeParams
...
---@param params ccc.kit.LSP.WorkDoneProgressCreateParams
...
---@param params ccc.kit.LSP.CallHierarchyPrepareParams
...
---@param params ccc.kit.LSP.CallHierarchyIncomingCallsParams
...
---@param params ccc.kit.LSP.CallHierarchyOutgoingCallsParams
...
---@param params ccc.kit.LSP.SemanticTokensParams
...
---@param params ccc.kit.LSP.SemanticTokensDeltaParams
...
---@param params ccc.kit.LSP.SemanticTokensRangeParams
...
---@param params ccc.kit.LSP.ShowDocumentParams
...
---@param params ccc.kit.LSP.LinkedEditingRangeParams
...
---@param params ccc.kit.LSP.CreateFilesParams
...
---@param params ccc.kit.LSP.RenameFilesParams
...
---@param params ccc.kit.LSP.DeleteFilesParams
...
---@param params ccc.kit.LSP.MonikerParams
...
---@param params ccc.kit.LSP.TypeHierarchyPrepareParams
...
---@param params ccc.kit.LSP.TypeHierarchySupertypesParams
...
---@param params ccc.kit.LSP.TypeHierarchySubtypesParams
...
---@param params ccc.kit.LSP.InlineValueParams
...
---@param params ccc.kit.LSP.InlayHintParams
...
---@param params ccc.kit.LSP.InlayHint
...
---@param params ccc.kit.LSP.DocumentDiagnosticParams
...
---@param params ccc.kit.LSP.WorkspaceDiagnosticParams
...
---@param params ccc.kit.LSP.RegistrationParams
...
---@param params ccc.kit.LSP.UnregistrationParams
...
---@param params ccc.kit.LSP.InitializeParams
...
---@param params ccc.kit.LSP.ShowMessageRequestParams
...
---@param params ccc.kit.LSP.WillSaveTextDocumentParams
...
---@param params ccc.kit.LSP.CompletionParams
...
---@param params ccc.kit.LSP.CompletionItem
...
---@param params ccc.kit.LSP.HoverParams
...
---@param params ccc.kit.LSP.SignatureHelpParams
...
---@param params ccc.kit.LSP.DefinitionParams
...
---@param params ccc.kit.LSP.ReferenceParams
...
---@param params ccc.kit.LSP.DocumentHighlightParams
...
---@param params ccc.kit.LSP.DocumentSymbolParams
...
---@param params ccc.kit.LSP.CodeActionParams
...
---@param params ccc.kit.LSP.CodeAction
...
---@param params ccc.kit.LSP.WorkspaceSymbolParams
...
---@param params ccc.kit.LSP.WorkspaceSymbol
...
---@param params ccc.kit.LSP.CodeLensParams
...
---@param params ccc.kit.LSP.CodeLens
...
---@param params ccc.kit.LSP.DocumentLinkParams
...
---@param params ccc.kit.LSP.DocumentLink
...
---@param params ccc.kit.LSP.DocumentFormattingParams
...
---@param params ccc.kit.LSP.DocumentRangeFormattingParams
...
---@param params ccc.kit.LSP.DocumentOnTypeFormattingParams
...
---@param params ccc.kit.LSP.RenameParams
...
---@param params ccc.kit.LSP.PrepareRenameParams
...
---@param params ccc.kit.LSP.ExecuteCommandParams
...
---@param params ccc.kit.LSP.ApplyWorkspaceEditParams
